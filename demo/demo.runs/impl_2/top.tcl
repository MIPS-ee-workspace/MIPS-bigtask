...
set rc [catch {
  ...
  set_property ip_repo_paths f:/codes/vivado/demo/demo.cache/ip [current_project]
  set_property ip_output_repo f:/codes/vivado/demo/demo.cache/ip [current_project]
  add_files -quiet F:/codes/vivado/demo/demo.runs/synth_1/top.dcp
